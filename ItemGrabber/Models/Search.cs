...
namespace ItemGrabber.Models
{
    public class Search
    {
        ...
        private static List<SelectListItem> selectedList = new List<SelectListItem>
        ...
        public ReadOnlyCollection<SelectListItem> selectList { get; private set; }
        public Search()
        {
            selectList = new ReadOnlyCollection<SelectListItem>(selectedList);
        }
    }
}